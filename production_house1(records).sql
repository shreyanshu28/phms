...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2021 at 04:55 PM
...
(1, 'canon35d', 10, '100000.00', 'CAMERA'),
(2, 'so54ny', 15, '10000.00', 'CAMERA'),
(3, 'sony1000nits', 5, '100.00', 'LIGHT'),
...
(5, '123, kushal', 'kushal', 'SURAT', 123456, 8);
...
CREATE TABLE `tblusermaster` (
  ...
  `role` char(1) NOT NULL DEFAULT 'C' COMMENT 'Role for the User\r\nDefault(''C''),\r\n''C'' for Customer,\r\n''E'' for Editor,\r\n''P'' for Photographer',
...
(2, 'kushal', 'k', 'gaywala', '1970-12-24', 'M', 928374563712, 'admin@gmail.com', '11111111', 'A', '1', 1),
(3, 'shrey', 'middleLorem', 'lastLorem', '1970-12-10', 'M', 918374857362, 'shrey@email.com', '', 'C', '1', 1),
(4, 'pujan', 'middleLorem1', 'jariwala', '1970-12-09', 'M', 919384738473, 'pujan@email.com', '', 'C', '1', 1),
(5, 'test1', 'testmiddle1', 'testlast1', '2000-07-05', 'M', 918374837483, 'test1@gmail.com', '', 'C', '1', 1),
(6, 'test2', 'testmiddle2', 'testlast2', '1998-08-12', 'F', 918475677893, 'test2@mail.com', '', 'C', '1', 1),
(7, 'city', 'citymiddle', 'citylast', '1999-03-23', 'F', 91, 'city@test.com', '', 'C', '1', 1),
(8, 'kushal', NULL, 'kushallast', '2000-11-21', 'M', 910123456789, 'kushal@gmail.com', '11111111', 'C', NULL, 1);
...
--
ALTER TABLE `tblproductmaster`
  MODIFY `pid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Unique identification key for products', AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbluseraddress`
--
ALTER TABLE `tbluseraddress`
  MODIFY `uaid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'primary key of customer address', AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tblusermaster`
--
ALTER TABLE `tblusermaster`
  MODIFY `uid` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key for tblUser', AUTO_INCREMENT=9;
