...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2021 at 11:10 AM
...
--
-- Dumping data for table `tblinventorytype`
--

INSERT INTO `tblinventorytype` (`itid`, `iType`) VALUES
(1, 'Camera'),
(2, 'VideoCamera');
...
(1, 1, 5, '38000.00', 'Apricus Productions', 1),
(2, 1, 2, '5000.00', 'Kushal Company', 1);
...
--
-- Dumping data for table `tblprops`
--

INSERT INTO `tblprops` (`pId`, `pName`) VALUES
(1, 'Canon EOS 1500D');
...
ALTER TABLE `tblinventorytype`
  ...
  ADD UNIQUE KEY `iType` (`iType`),
  ADD UNIQUE KEY `iType_2` (`iType`);
...
--
ALTER TABLE `tblinventorytype`
  MODIFY `itid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'primary key for tblInventoryType', AUTO_INCREMENT=4;
...
--
ALTER TABLE `tblpropownership`
  MODIFY `poid` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'primary key for tblPropOwnership', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tblprops`
--
ALTER TABLE `tblprops`
  MODIFY `pId` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'primary key for tblProp', AUTO_INCREMENT=2;
