...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2021 at 01:54 PM
...
--
ALTER TABLE `tblcart`
  MODIFY `cartid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Unique Identification key for cart', AUTO_INCREMENT=8;
...
--
ALTER TABLE `tblpackagepaymentorder`
  MODIFY `ppoid` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Unique Identification key for the Payment Package Order';
...
ALTER TABLE `tblpackagepaymentorder`
  ...
  ADD CONSTRAINT `FK_tblPackagePaymentOrder_tblPaymentOrder` FOREIGN KEY (`poid`) REFERENCES `tblpaymentorder` (`poid`);
