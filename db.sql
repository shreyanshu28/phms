...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2021 at 08:18 PM
...
--
-- Table structure for table `tblorderaddress1`
--

CREATE TABLE `tblorderaddress1` (
...
--
-- Dumping data for table `tblorderaddress1`
--

INSERT INTO `tblorderaddress1` (`oaid`, `addressline1`, `addressline2`, `city`, `pincode`, `cid`) VALUES
(1, '1111', '', 'VALSAD', 111111, 8);
...
(3, 'ONLINE', '', '2021-10-26', '07:54:46', '500.00', 1);
...
--
-- Indexes for table `tblorderaddress1`
--
ALTER TABLE `tblorderaddress1`
...
--
ALTER TABLE `tblcart`
  MODIFY `cartid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Unique Identification key for cart', AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tblorderaddress1`
--
ALTER TABLE `tblorderaddress1`
  MODIFY `oaid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tblordermaster`
  MODIFY `oid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Unique identification key for orders', AUTO_INCREMENT=4;
...
--
ALTER TABLE `tblpackagepaymentorder`
  MODIFY `ppoid` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Unique Identification key for the Payment Package Order', AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `tblpaymentorder1`
--
ALTER TABLE `tblpaymentorder1`
  MODIFY `poid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `tblordertransaction`
  ...
  ADD CONSTRAINT `FK_tblOrderTransaction_tblPaymentOrder` FOREIGN KEY (`poid`) REFERENCES `tblpaymentorder1` (`poid`),
